...
{
  /// <summary>
  /// Proporciona un contenedor en un objeto de firma XML base para facilitar la creación de firmas XML ampliando la
  /// funcionalidad de 'SignedXml' según las especificaciones de VERI*FACTU.
  /// </summary>
...
#pragma warning disable CS0108
    ...
    /// <summary>
    /// Representa un documento xml firmado derivado de la clase SignedXml para añadir la lógica de firma según las
    /// especificaciones de VERI*FACTU.
    /// </summary>
    ...
    /// <summary>
    /// Recupera el elemento xml con el atributo Id igual al valor pasado como argumento en 'idValue' dentro de la lista
    /// de nodos xml 'nodeList'.
    /// </summary>
    /// <param name="nodeList">Lista de nodos xml en la que buscar el elemento.</param>
    /// <param name="idValue">Valor del atributo Id.</param>
    /// <returns>
    /// Elemento encontrado con atributo Id igual a 'idValue' o null si no se encuentra.
    /// </returns>
    ...
    /// <summary>
    /// Obtiene el valor de la propiedad privada 'm_context' de la  clase madre 'SignedXml' utilizando reflection.
    /// </summary>
    /// <returns>
    /// Valor de la propiedad privada 'm_context' de la  clase madre 'SignedXml'.
    /// </returns>
    ...
    /// <summary>
    /// Contruye los elemento xml de las referencias de la firma calculando las huellas correspondientes a cada una.
    /// Invocamos al método no público de la clase madre 'SignedXml' con reflection.
    /// </summary>
    ...
    private byte[] GetC14NDigest(HashAlgorithm hash, string prefix)
    {
      ...
      XmlElement _context = GetContext();
    ...
    /// <summary>
    /// Establece la propiedad 'Prefix' entre los nodos hijos de un nodo y sobre sus nodos hijos de forma recursiva. Se
    /// realiza el proceso hasta alcanzar el nodo 'xades:QualifyingProperties'.
    /// </summary>
    ...
    /// </summary>
    /// <param name="prefix">
    /// Prefijo a fijar antes del computo de la firma.
    /// </param>
    ...
    /// <summary>
    /// Recupera un elemento xml a partir de la instancia actual.
    /// </summary>
    /// <param name="prefix">Prefijo a establecer.</param>
    /// <returns>
    /// Elemento xml a partir de la instancia actual.
    /// </returns>
    ...
    /// <summary>
    /// Recupera el elemento xml con el atributo Id igual al valor pasado como argumento en 'idValue' dentro del
    /// documento xml 'document'.
    /// </summary>
    ...
    public override XmlElement GetIdElement(XmlDocument document, string idValue)
    {
      ...
      {
        XmlNodeList nodeList = dsObj.Data;
        if(nodeList != null)
        {
