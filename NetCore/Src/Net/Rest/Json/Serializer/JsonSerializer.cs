...
namespace VeriFactu.Net.Rest.Json.Serializer
{
  ...
  internal class JsonSerializer
  {
    ...
    /// </summary>
    private static readonly Dictionary<Type, IJsonSerializer> _SerializersByType = new Dictionary<Type, IJsonSerializer>
    {
    ...
    /// <summary>
    /// Serializador para los parámetros facilitados en el constructor.
    /// </summary>
    ...
    internal JsonSerializer(PropertyInfo pInf, object value)
    {
      ...
      {
        FieldInfo enumItemField = _Value.GetType().GetField($"{value}");
        if(enumItemField != null)
        {
          XmlEnumAttribute xmlEnumAtt = enumItemField.GetCustomAttribute(typeof(XmlEnumAttribute)) as XmlEnumAttribute;
    ...
    public string ToJson()
    {
      ...
      bool seralizeEnumDefault = type.IsEnum;
      if(Attribute != null)
      {
