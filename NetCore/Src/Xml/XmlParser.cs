...
namespace VeriFactu.Xml
{
  ...
  public class XmlParser
  {
    ...
    /// <summary>
    /// Devuelve una fecha formateada para un campo FechaHoraHuso de la especificación de VeriFactu.
    /// </summary>
    ...
    {
      DateTime input = date ?? new DateTime(1, 1, 1);
    ...
    /// <summary>
    /// Devuelve una fecha formateada para un campo de fecha de la especificación de VeriFactu.
    /// </summary>
    /// <param name="date">fecha a formatear</param>
    ...
    /// <summary>
    /// Devuelve un importe formateado para un campo decimal de la especificación de VeriFactu.
    /// </summary>
    ...
    /// <summary>
    /// Devuelve un decimal a partir de un string de un campo de xml que representa un valor decimal.
    /// </summary>
    ...
    /// <summary>
    /// Devuelve una fecha a partir de un string de un campo de xml que representa un valor decimal.
    /// </summary>
    ...
    /// <summary>
    /// Serializa el objeto como xml y lo devuelve como archivo xml en una cadena.
    /// </summary>
    ...
    /// <summary>
    /// Serializa el objeto como xml y lo devuelve como archivo xml canonicalizado en una cadena.
    /// </summary>
    /// <param name="instance">Instancia de objeto a serializar.</param>
    /// <param name="namespaces">Espacios de nombres.</param> 
    /// <param name="indent">Indica si se debe utilizar indentación.</param>
    ...
    {
      string xmlContent = Encoding.GetString(GetBytes(instance, namespaces, indent, omitXmlDeclaration));
    ...
    /// <summary>
    /// Serializa el objeto como xml y lo devuelve como archivo xml como cadena de bytes.
    /// </summary>
    /// <param name="instance">Instancia de objeto a serializar.</param>
    /// <param name="namespaces">Espacios de nombres.</param> 
    /// <param name="indent">Indica si se debe utilizar indentación.</param>
    ...
    /// <summary>
    /// Obtiene una intancia de un tipo determinado a partir de un string con un xml válido para  la representación del
    /// tipo.
    /// </summary>
    ...
    public T GetInstance<T>(string xml)
    {
      ...
      XmlSerializer instance = new XmlSerializer(typeof(T));
