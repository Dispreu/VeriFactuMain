...
namespace VeriFactu.Qrcode
{
  ...
  /// <remarks>
  /// This class contains utility methods for performing mathematical operations over the Galois Field GF(256).
  /// Operations use a given primitive polynomial in calculations. <para/> Throughout this package, elements of GF(256)
  /// are represented as an <c>int</c> for convenience and speed (but at the cost of memory). Only the bottom 8 bits are
  /// really used.
  /// </remarks>
  ...
  internal sealed class GF256
  {
    ...
    /// irreducible polynomial whose coefficients are represented by the bits of an int, where the least-significant bit
