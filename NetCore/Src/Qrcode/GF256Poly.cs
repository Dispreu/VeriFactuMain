...
namespace VeriFactu.Qrcode
{
  ...
  /// </summary>
  /// <remarks>
  /// Represents a polynomial whose coefficients are elements of GF(256). Instances of this class are immutable. <para/>
  ...
  internal sealed class GF256Poly
  {
    ...
    /// <param name="field">
    /// the <see cref="GF256"/> instance representing the field to use to perform computations
    /// </param>
    /// <param name="coefficients">
    /// coefficients as ints representing elements of GF(256), arranged from most significant (highest-power term)
