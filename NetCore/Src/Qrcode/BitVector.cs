...
{
  /// <summary>
  /// JAVAPORT: This should be combined with BitArray in the future, although that class is not yet dynamically
  /// resizeable.
  /// </summary>
  /// <remarks>
  /// JAVAPORT: This should be combined with BitArray in the future, although that class is not yet dynamically
  /// resizeable. This implementation is reasonable but there is a lot of function calling in loops I'd like to get rid
  /// of.
  /// </remarks>
  ...
  internal sealed class BitVector
  {
    ...
    /// </summary>
    /// <remarks>
    /// Append "numBits" bits in "value" to the bit vector. Examples: - appendBits(0x00, 1) adds 0. - appendBits(0x00,
    /// 4) adds 0000. - appendBits(0xff, 8) adds 11111111.
    /// </remarks>
    ...
    //
    /// <summary>
    /// Callers should not assume that array.length is the exact number of bytes needed to hold sizeInBits - it will
    /// typically be larger for efficiency.
    /// </summary>
