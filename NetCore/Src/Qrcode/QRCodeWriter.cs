...
namespace VeriFactu.Qrcode
{
  ...
  public sealed class QRCodeWriter
  {
    ...
    /// <summary>
    /// Encode a string into a QR code with dimensions width x height, using error-correction level L and the smallest
    /// version for which he contents fit into the QR-code?
    /// </summary>
    ...
    /// </summary>
    /// <remarks>
    /// Encode a string into a QR code with dimensions width x height. Hints contains suggestions for error-correction
    /// level and version. The default error-correction level is L, the default version is the smallest version for
    /// which the contents will fit into the QR-code.
    /// </remarks>
    /// <param name="contents">String to encode into the QR code</param>
    /// <param name="width">width of the QR-code</param>
    /// <param name="height">height of the QR-code</param>
