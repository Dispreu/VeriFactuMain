...
namespace VeriFactu.Qrcode
{
  ...
  internal sealed class QRCode
  {
    ...
    /// </summary>
    /// <remarks>
    /// Mode used by the QR code to encode data into bits. Possible values: TERMINATOR, NUMERIC, ALPHANUMERIC,
    /// STRUCTURED_APPEND, BYTE, ECI, KANJI, FNC1_FIRST_POSITION, FNC2_SECOND_POSITION
    /// </remarks>
    ...
    /// <summary>
    /// Together with error correction level, the version determines the information capacity of the QR code.
    /// </summary>
    /// <remarks>
    /// Together with error correction level, the version determines the information capacity of the QR code. Higher
    /// version numbers correspond with higher capacity. Ranges from 1 to 40.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// Retrieve the value of the module (cell) pointed by "x" and "y" in the matrix of the QR Code. 1 represents a
    /// black cell, and 0 represents a white cell.
    /// </remarks>
 ...
 matrix.GetWidth() == matrix.GetHeight();
    ...
    /// <summary>
    /// Set the data encoding mode of the QR code Possible modes: TERMINATOR, NUMERIC, ALPHANUMERIC, STRUCTURED_APPEND,
    /// BYTE, ECI, KANJI, FNC1_FIRST_POSITION, FNC2_SECOND_POSITION
    /// </summary>
    ...
    /// </summary>
    /// <remarks>
    /// Set the error correction level of th QR code. Possible error correction level values ranked from lowest error
    /// correction capability to highest: L, M, Q, H
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// Set the version of the QR code. Together with error correction level, the version determines the information
    /// capacity of the QR code. Higher version numbers correspond with higher capacity. Range: 1 to 40.
    /// </remarks>
