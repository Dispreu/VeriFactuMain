...
namespace VeriFactu.Qrcode
{
  ...
  internal sealed class MaskUtil
  {
    ...
    /// </summary>
    /// <remarks>
    /// Apply mask penalty rule 1 and return the penalty. Find repetitive cells with the same color and give penalty to
    ...
    /// </summary>
    /// <remarks>
    /// Apply mask penalty rule 3 and return the penalty. Find consecutive cells of 00001011101 or 10111010000, and give
    /// penalty to them.  If we find patterns like 000010111010000, we give penalties twice (i.e. 40 * 2).
    /// </remarks>
    /// <param name="matrix">ByteMatrix to apply the penalty rule to</param>
      ...
      for(int y = 0; y < height; ++y)
      {
        for(int x = 0; x < width; ++x)
        {
          ...
          if(x + 6 < width && array[y][x] == 1 && array[y][x + 1] == 0 && array[y][x + 2] == 1 && array[y][x + 3] ==
                         1 && array[y][x + 4] == 1 && array[y][x + 5] == 0 && array[y][x + 6] == 1 && ((x + 10 < width && array[y][x + 7] == 0 && array[y][x + 8] == 0 && array[y][
            x + 9] == 0 && array[y][x + 10] == 0) || (x - 4 >=
          ...
          if(y + 6 < height && array[y][x] == 1 && array[y + 1][x] == 0 && array[y + 2][x] == 1 && array[y + 3][x]
                        == 1 && array[y + 4][x] == 1 && array[y + 5][x] == 0 && array[y + 6][x] == 1 && ((y + 10 < height && array[y + 7][x] == 0 && array[y + 8][x] == 0 && array[
            y + 9][x] == 0 && array[y + 10][x] == 0) || (y - 4 >=
    ...
    /// </summary>
    /// <remarks>
    /// Apply mask penalty rule 4 and return the penalty. Calculate the ratio of dark cells and give penalty if the
    /// ratio is far from 50%. It gives 10 penalty for 5% distance. Examples: -   0% =&gt; 100 -  40% =&gt;  20 -  45%
    /// =&gt;  10 -  50% =&gt;   0 -  55% =&gt;  10 -  55% =&gt;  20 - 100% =&gt; 100
    /// </remarks>
