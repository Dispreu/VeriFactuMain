...
namespace VeriFactu.Qrcode
{
  ...
  internal sealed class ReedSolomonEncoder
  {
    ...
    /// <summary>
    /// Creates a SolomonEncoder object based on a <see cref="GF256"/> object.
    /// </summary>
    /// <remarks>
    /// Creates a SolomonEncoder object based on a <see cref="GF256"/> object. Only QR codes are supported at the
    /// moment.
    /// </remarks>
