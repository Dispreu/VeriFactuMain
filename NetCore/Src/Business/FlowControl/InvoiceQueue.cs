...
{
  /// <summary>
  /// Gestiona el envío de registros a la AEAT con los intervalos de espera establecidos entre envíos. <para>Según lo
  /// establecido en la Orden HAC/1177/2024, de 17 de octubre en su Artículo 16.</para>
  /// </summary>
  public class InvoiceQueue : IntervalWorker
  {
    ...
    /// </summary>
    private readonly Dictionary<string, SellerQueue> _SellerPendingQueue;
    ...
    private InvoiceQueue()
    {
      if(ActiveInvoiceQueue != null)
      {
        throw new InvalidOperationException(
          "Ya existe una instancia de gestor de cola actualmente en el sistema." +
    ...
    /// <summary>
    /// Recupera la instancia que se encarga de gestionar la cola de facturas pendientes de envío.
    /// </summary>
    /// <returns>
    /// Instancia que se encarga de gestionar la cola de facturas pendientes de envío.
    /// </returns>
    ...
    public static void DoExit()
    {
      if(ActiveInvoiceQueue.Count > 0)
      {
        throw new OperationCanceledException(
          $"No se puede finalizar la cola de factura con" +
    ...
    /// <summary>
    /// Almacena el gestor de cola actualmente activo en el sitema.
    /// </summary>
    ...
    public void Add(InvoiceAction invoiceAction)
    {
      ...
      SellerQueue queue = SellerQueue.Get(invoiceAction.SellerID);
