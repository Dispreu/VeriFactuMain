...
namespace VeriFactu.Business.Validation.Validators.Anulacion
{
  ...
  public class ValidatorRegistroAnulacionInterlocutor : ValidatorRegistroAnulacion
  {
    ...
    public ValidatorRegistroAnulacionInterlocutor(
      Envelope envelope,
      RegistroAnulacion registroAnulaciona,
      Interlocutor interlocutor,
      string rol,
      bool allowNoCensado = false) : base(envelope, registroAnulaciona)
    {
    ...
    protected override List<string> GetBlockErrors()
    {
      ...
      if(!string.IsNullOrEmpty(_Interlocutor.NIF))
      {
        ...
        {
          result.Add(
            $"Error en el bloque RegistroAnulacion: El NIF del {_Rol} {_Interlocutor.NIF}" +
