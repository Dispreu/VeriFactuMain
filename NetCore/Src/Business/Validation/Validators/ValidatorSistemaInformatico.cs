...
namespace VeriFactu.Business.Validation.Validators
{
  ...
  public class ValidatorSistemaInformatico : InvoiceValidation
  {
    ...
    /// <summary>
    /// Devuelve los errores de validación de una instancia de la clase SistemaInformatico.
    /// </summary>
    /// <param name="sistemaInformatico">
    /// Instancia de la clase SistemaInformatico a validar.
    /// </param>
    /// <returns>
    /// Lista con las descripciones de los errores de validación de una instancia de la clase SistemaInformatico.
    /// </returns>
    private List<string> GetErrors(SistemaInformatico sistemaInformatico)
    {
      List<string> result = new List<string>();
      SistemaInformatico interlocutor = sistemaInformatico;
      ...
      {
        result.Add(
          $"Error en el bloque SistemaInformatico ({sistemaInformatico}):" +
      ...
      if(sistemaInformatico != null && sistemaInformatico.IDOtro != null)
      {
        ...
        bool isValidViesVatNumber = Settings.Current.SkipViesVatNumberValidation ? true : ViesVatNumber.Validate(sistemaInformatico.IDOtro.ID);
