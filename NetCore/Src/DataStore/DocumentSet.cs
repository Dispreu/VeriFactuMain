...
{
  /// <summary>
  /// Representa un conjunto de documentos de factura generado en el sistema. Incluye todos los registros de alta y
  /// anulación envíados, así como todas las respuestas de la AEAT relacionadas con las facturas de un emisor y periodo
  /// determinados.
  /// </summary>
  public class DocumentSet
  {
    ...
    /// <summary>
    /// Representa un periodo de facturación de un vendedor o emisor de facturas en cuanto a los documentos de salida
    /// del sistema en forma de registros de alta o anulación.
    /// </summary>
    ...
    /// <summary>
    /// Crea un gestor de los documentos de salida de un periodo y emisor concretos.
    /// </summary>
    ...
    /// <summary>
    /// <para>Devuelve los documentos:</para> <para>Que no tengan una respuesta con estado 'Correcto'</para>
    /// </summary>
    /// <returns>
    /// Documentos con registro de salida que no tengan una respuesta con estado 'Correcto'.
    /// </returns>
    public Dictionary<string, DocumentBox> GetErrors()
    {
      ...
      Dictionary<string, DocumentBox> errors = new Dictionary<string, DocumentBox>();
      foreach(KeyValuePair<string, DocumentBox> outDoc in DocumentsOut)
      {
        ...
        {
          DocumentBox inDoc = DocumentsIn[outDoc.Key];
          bool isError = true;
          foreach(object record in inDoc.Records)
          {
            RespuestaLinea respuesta = record as RespuestaLinea;
            if(respuesta == null)
            {
              throw new InvalidOperationException(
                $"Error en documento de entrada {record}:" +
    ...
    /// <summary>
    /// Devuelve las respuestas correspondientes al envío de un documento.
    /// </summary>
    /// <param name="docKey">Clave del documento de factura.</param>
    /// <returns>
    /// Respuestas correspondientes al envío de un documento.
    /// </returns>
